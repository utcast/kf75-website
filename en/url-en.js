...
const RESOURCE_TOP = (() => {
	if (location.hostname == "utcast.github.io") {
		return "https://raw.githubusercontent.com/utcast/kf95-website/draft/contents-en";
	} else if (location.hostname == "ut-cast.net") {
		return "https://raw.githubusercontent.com/utcast/kf95-website/main/contents-en";
	} else {
		return "../contents-en";
	}
})();
